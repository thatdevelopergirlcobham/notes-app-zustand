...
export function EditNote({ onClose, onSave, initialColor, initialData }: EditNoteProps) {
    ...
    return (
        <div
            className={`w-full max-w-lg rounded-3xl shadow-2xl p-6 ${getColorClass(initialColor)} relative animate-fade-in-up`}
